...
if (argv.advisories.length > 0) {
  console.error(
    red,
    "ERROR: Using removed `advisories` argument. Use `--allowlist` as a drop-in replacement."
  );
}
...
if (argv["path-whitelist"].length > 0) {
  console.error(
    red,
    "ERROR: Using removed `path-whitelist` argument. Use `--allowlist` as a drop-in replacement."
  );
}
...
if (argv.whitelist.length > 0) {
  console.error(
    red,
    "ERROR: Using removed `whitelist` argument. Use `--allowlist` as a drop-in replacement."
  );
}
argv.w = undefined;
